...
async function drawCanvas() {
  ...
  await plotMandelbrot(zoom, offsetX, offsetY, iterations, colorR, colorG, colorB);
...
async function loadWasm(callback) {
  const wasm = await WebAssembly
    .instantiateStreaming(fetch('./mandelbrot.wasm'), {
      index: { callback },
      env: {
...
async function plotMandelbrot(zoom, offsetX, offsetY, iterations, colorR, colorG, colorB) {
